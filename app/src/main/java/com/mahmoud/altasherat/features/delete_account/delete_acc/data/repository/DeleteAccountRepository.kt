...
class DeleteAccountRepository(
    ...
    override suspend fun deleteAccount(passwordRequest: DeleteAccRequest): String {
        return deleteAccDS.deleteAccount(passwordRequest, userLocalDS.getUserAccessToken())
    }
}