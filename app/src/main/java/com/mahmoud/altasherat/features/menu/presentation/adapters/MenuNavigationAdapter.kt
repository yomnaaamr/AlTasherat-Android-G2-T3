package com.mahmoud.altasherat.features.menu.presentation.adapters
...
class MenuNavigationAdapter(private val onItemClick: (NavigationItem) -> Unit) :
    ListAdapter<NavigationItem, MenuNavigationAdapter.MenuItemViewHolder>(ProfileDestinationDiffCallback()) {
